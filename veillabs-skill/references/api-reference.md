...
|----------|-------------|---------|
| `VEILLABS_BASE_URL` | Base API URL | `https://veillabs.app` or `http://localhost:3000` |
...
|------|-------------|
| `200` | Success |
| `400` | Bad Request — missing fields, below minimum amount, invalid private key, total amount mismatch |
